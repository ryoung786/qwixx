defmodule QwixxWeb.Components do
  ...
  defdelegate button(assigns), to: QwixxWeb.Component.Button
  defdelegate label(assigns), to: QwixxWeb.Component.Label
  defdelegate input(assigns), to: QwixxWeb.Component.Input
  ...
  def dice_icon(assigns) do
    ...
    ~H"""
    <div id={@id} class={["rounded grid place-items-center size-10", @light]} data-dice-icon>
      <.icon name={"lucide-dice-#{@n}"} class={"#{@class} #{@dark} size-full"} />
    </div>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(QwixxWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(QwixxWeb.Gettext, "errors", msg, opts)
    # end
