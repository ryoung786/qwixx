defmodule QwixxWeb.Component.Sidebar do
  @moduledoc false
  ...
  def sidebar(assigns) do
    ...
    <div
      ...
      data-side={@side}
      id={@id}
      phx-toggle-sidebar={toggle({"none", @collapsible})}
    >
      <div class={
        classes([
  ...
  def input(assigns) do
    ~H"""
    <QwixxWeb.Component.Input.input
      data-sidebar="input"
      class={
        classes([
  ...
  def menu_sub_button(assigns) do
    ~H"""
    <.dynamic
      tag={@as_tag}
  ...
  """
  def toggle({state1, state2} = _collapsible_states) do
